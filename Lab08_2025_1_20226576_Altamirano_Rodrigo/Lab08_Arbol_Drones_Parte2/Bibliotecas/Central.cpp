...
void Central::actualiza() {
    int cantDronVelocidad=0,cantDronSemaforo=0,cantDronEstacionamiento=0,
    cantDronSemActualizacion,cantDronEstActualizacion;
    this->ADrones.contarDronesABB(cantDronVelocidad,cantDronSemaforo,cantDronEstacionamiento);
    cantDronSemActualizacion=0.5*cantDronSemaforo;
    cantDronEstActualizacion=0.5*cantDronEstacionamiento;
    this->ADrones.actualizarABB(cantDronSemActualizacion,cantDronEstActualizacion);
}
