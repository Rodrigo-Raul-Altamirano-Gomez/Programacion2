...
int Boleta::getEscalaAlumno() const {
    return this->pboleta->getEscala();
}
...
void Boleta::actualizar(double precioEscala) {
    double creditos=this->pboleta->getCreditos();
    double totalBruto=precioEscala*creditos;
    this->pboleta->actualizatotal(totalBruto);
}
